...
public class CalculatorTests
{
    ...
    {
        // Arrange & Act
        Calculator.Add(1, 2, out double result);
    ...
    {
        // Arrange & Act
        Calculator.Subtract(3, 2, out double result);
    ...
    {
        // Arrange & Act
        Calculator.Multiply(3, 2, out double result);
    ...
    {
        // Arrange & Act
        Calculator.Divide(10, 5, out double result);
